...
provides the Bit.ly framework extension allowing applications to easily 
shorten long urls using their service.
...
setup(name='cement2.ext.bitly',
    version=VERSION,
    description="Bit.ly Framework Extension for Cement",
